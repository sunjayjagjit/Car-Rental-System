...
<tr>
	...
	<form>		
		...
		<a href="user_edit.php" target="_parent"><input type="button" name="Update Now"value="Edit">
...
if (isset($_POST["updatebtn"]))
{
	...
	mysqli_query($conn,"update admin set user_username='$name',user_password='$pass',user_email='$email',user_contactnumber='$contact'
	where user_id=$aid");
